  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            <div className="bg-red-100 dark:bg-red-950/30 p-3 rounded-full">
              <FaTint className="w-6 h-6 text-red-600 dark:text-red-400" />
            </div>
            <div>
          ...
          <span className="bg-yellow-100 dark:bg-yellow-950/30 text-yellow-800 dark:text-yellow-200 text-sm font-medium px-3 py-1 rounded-full">
            Urgent Request
          </span>
        </div>
        ...
        {/* Success Message */}
        {confirmMessage && (
          <Card className="mb-6 border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/30 shadow-md">
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                <FaHandHoldingHeart className="w-5 h-5 text-green-600" />
                <p className="text-green-800 dark:text-green-200 font-medium">{confirmMessage}</p>
              </div>
            </CardContent>
          </Card>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-600 dark:text-gray-400">
                        Blood Group: <span className="font-semibold text-red-600 dark:text-red-400">{request.bloodGroup}</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg space-y-2">
                      <div className="flex items-center">
                        <FaHospital className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" />
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                      <div className="flex items-center space-x-6">
                        ...
                        <div className="flex items-center">
                          <FaClock className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" />
                  ...
                  {request.requestMessage && (
                    <div>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                        <p className="text-gray-700 dark:text-gray-300">{request.requestMessage}</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          {/* Action Panel */}
          <div>
            <Card className="sticky top-8 border-red-100 dark:border-red-900/30 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-red-50 dark:bg-red-950/30 p-4 rounded-lg">
                    <div className="flex items-center justify-center space-x-2 mb-2">
                      <FaTint className="w-5 h-5 text-red-600 dark:text-red-400" />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg space-y-2">
              ...
              <div>
                ...
                <span className="ml-2 text-red-600 dark:text-red-400 font-semibold">{user?.bloodGroup}</span>
              </div>
            </div>

            {confirmError && (
              <p className="text-red-600 dark:text-red-400 text-sm">{confirmError}</p>
            )}
